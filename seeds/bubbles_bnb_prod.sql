...
INSERT INTO spaces (name, description, price_per_night, booked_flag, image_path, user_id) VALUES ('Highgarden House', 'Situated within walking distance of most of the main attractions of Highgarden, this luxurious appartment would suit a family of up to 5, with three bedrooms, two en-suite bathrooms and a shared bathroom', 150.00, False, 'img/mock-1.jpg', 1);
INSERT INTO spaces (name, description, price_per_night, booked_flag, image_path, user_id) VALUES ('Ramsey Beach', 'If you love the sea and sun, visit us here at Ramsey Beach. Our property is perfectly set up for sandy fun with a veranda straight onto the beach', 100.00, False, 'img/mock-2.jpg', 1);
INSERT INTO spaces (name, description, price_per_night, booked_flag, image_path, user_id) VALUES ('Emerald City', 'Your magical adventure starts here! Bring your loved ones along for a visit that you will never forget!', 70.00, False, 'img/mock-3.jpg', 2);
INSERT INTO spaces (name, description, price_per_night, booked_flag, image_path, user_id) VALUES ('Summerfields', 'Hazy days spent with those you love. Summerfields is a location that you will remember forever.', 120.00, False, 'img/mock-4.jpg', 2);
